<template>
	<view class="demo-topbar">
		<cl-card label="默认">
			<cl-topbar title="标题" :is-top="false"></cl-topbar>
		</cl-card>

		<cl-card label="带描述">
			<cl-topbar title="标题" description="描述" :is-top="false"></cl-topbar>
		</cl-card>

		<cl-card label="右侧图标">
			<cl-topbar title="标题" :is-top="false">
		...
		<cl-card label="不需要返回键">
			<cl-topbar title="标题" :show-back="false" :is-top="false"></cl-topbar>
		</cl-card>
